            ...
            <div className="flex flex-col items-start justify-start w-full">
                <div className="flex items-center w-full space-x-3">
                    <div className="relative">
                        ...
                        />
                        <div
                            className="absolute -bottom-1 -right-1 w-6 h-6 rounded-full p-[2px] flex justify-center items-center shadow">
                            <Image
                                src={walletIconSrc}
                ...
                <div
                    ...
                    <p className="text-white/70 text-base">Veloxi Points</p>
